...
export default async function DocusaurusTerminologyPlugin(context, options) {
  ...
  return {
    ...
    configureWebpack(config, isServer, utils) {
      ...
      if (rule) {
        rule.oneOf = [
          {
            ...
            use: [
              {
                loader: "./plugins/webpack-glossary-loader",
                options,
              },
            ],
          },
          {
            ...
            use: [
              {
                loader: "./plugins/webpack-terms-loader",
                options,
              },
            ],
          },
        ...
        rule.use.push({
          loader: "./plugins/webpack-terms-replace-loader",
          options,
        });
      }
      return {
