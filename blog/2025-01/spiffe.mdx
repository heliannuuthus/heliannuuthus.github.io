...
> psat(:term[Projected]{./blog/terms/k8s#projected-volume} Service Account Token) 是 k8s 1.12 版本引入的概念，在 1.20 版本稳定的一种新的服务账户令牌，用于替代 sat(Service Account Token)
...
<Collapse label="采用 aws_iid 的自证方式验证身份">
```mermaid
sequenceDiagram
