...
2. 进程间切换的上下文开销大，线程间切换的上下文开销小，协程间切换的上下文开销最小。
   ...
   - 进程：由[[**用户态**]](/terms/java#user-mode)切换到[[**内核态**]](/terms/java#kernel-mode)，切换并保存[[**虚拟地址空间**]](/terms/java#virtual-address-space)、[[**页表**]](/terms/java#page-table)、[[**内核栈**]](/terms/java#kernel-stack)等，开销非常大。
   - 线程：由[[**用户态**]](/terms/java#user-mode)切换到[[**内核态**]](/terms/java#kernel-mode)
   ...
   - 协程：**永远在[[**用户态**]](/terms/java#user-mode)**，虽然也会像线程一样做一系列操作，但将内核态转换的过程抽象到协程库实现，开销最小。
