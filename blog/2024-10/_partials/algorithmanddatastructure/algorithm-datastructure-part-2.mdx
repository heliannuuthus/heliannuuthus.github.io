...
:::::::collapse{title="代码块以及图例"}

  ::::::tabs

    :::::tab{title="前序遍历" key="preOrder"}
      ![二叉树的前序遍历](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/二叉树的前序遍历-2024-11-20-20-41-25.png)
      ::::tabs
    ...
    :::::tab{title="中序遍历" key="inOrder"}
      ...
      ![二叉树的中序遍历](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/二叉树的中序遍历-2024-11-20-20-44-04.png)
    ...
    :::::tab{title="后序遍历" key="postOrder"}
      ![二叉树的后序遍历](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/二叉树的后序遍历-2024-11-20-20-44-31.png)
    ...
    :::::tab{title="层序遍历" key="levelOrder"}
      ![二叉树的层序遍历](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/二叉树的层序遍历-2024-11-20-20-44-50.png)
      ::::tabs
...
![二叉树的高度和深度](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/二叉树的高度和深度-2024-11-20-20-51-52.png)
...
![前后序列无法构造二叉树](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/前后序列无法构造二叉树-2024-11-20-21-10-49.png)

::::steps

:::step{title="通过前序或者后序的第一个节点或者最后一个节点确定根节点"}

1. 前序（局部）的**第一个节点**或者后序（局部）的**最后一个节点**都代表的是**根（局部）节点**

:::

:::step{title="从中序查找对应的根节点并将该节点的左右子树分割开 [左子树, 根节点, 右子树]"}
...
:::step{title="通过递归的手段可以轻松构造左右子树"}
:::

::::
:::::collapse{title="代码块以及正在画的图例"}
...
- [构造最大二叉树](https://leetcode.cn/problems/maximum-binary-tree/description)
  ...
  - 遍历数组，找到最大值作为根节点
  - 使用递归的手段构造左右子树，如[构造二叉树](/blog/algorithm-datastructure#构造二叉树)
...
:text[二叉树的左旋]{align="center"}

![二叉树的左旋](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/二叉树的左旋-2024-11-20-20-57-58.png)

:text[二叉树的右旋]{align="center"}

![二叉树的右旋](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/二叉树的右旋-2024-11-20-20-57-41.png)
...
![完全二叉搜索树](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/完全二叉搜索树-2024-11-20-21-17-44.png)
...
- [二叉搜索树的最小绝对差](https://leetcode.cn/problems/minimum-absolute-difference-in-bst/description)
  ...
  - 利用 [Morris 遍历](/blog/algorithm-datastructure#morris-遍历)可以减少空间复杂度
...
![二搜索叉树的删除](https://cdn.jsdelivr.net/gh/heliannuuthus/heliannuuthus.github.io@assets/static/img/2024-11-20/二搜索叉树的删除-2024-11-20-22-02-37.png)
